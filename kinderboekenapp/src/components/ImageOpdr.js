...
let x = 0;
class ImageOpdr extends React.Component {
...
export default connect(mapStateToProps, { changeUserAssignments: changeUserAssignments, changeActiveBook: changeActiveBook } )(ImageOpdr);
