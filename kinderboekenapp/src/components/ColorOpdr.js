...
class ColorOpdr extends React.Component {
   ...
   this.getAssignData();
    ...
    render(props){
        ...
        <p>{this.props.assignment}</p> 
            ...
            <form><label htmlFor="color"></label><input className="color__input" id="color" name="color" type="color"></input></form>
            <label htmlFor="userColor">Schrijf hier je kleur op:</label>
            <input id="userColor" className="userColor" type="text" onSubmit={console.log('hoi')}></input>
...
export default connect(mapStateToProps, { changeUserAssignments: changeUserAssignments, changeActiveBook: changeActiveBook } )(ColorOpdr);
